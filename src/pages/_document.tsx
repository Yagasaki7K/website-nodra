			...
			<Html lang="pt-br">
				<NextSeo
					...
					openGraph={{
						...
						title: "NODRA | Software Company",
						description:
							"VibePass — Compre e venda seus ingressos de maneira 100% segura e confiável pela VibePass. Faculdade, eventos, bares, festas. Garanta seu ingresso com segurança e agilidade.",
						images: [
							{
								url: "/bg-seo.png",
								width: 460,
				...
				<Head>
					<meta
						name="keywords"
						content="venda, ingresso, revenda, faculdade, calouros, eventos, bares, festas, segurança, agilidade, vibepass, pass, ingressos, show, bar, brasil, comprar, vender, compra"
					/>
